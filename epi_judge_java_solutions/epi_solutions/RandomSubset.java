...
import epi_solutions.test_framework.RandomSequenceChecker;
...
public class RandomSubset {
  ...
  private static boolean randomSubsetRunner(epi_solutions.test_framework.TimedExecutor executor, int n,
    ...
    int totalPossibleOutcomes = epi_solutions.test_framework.RandomSequenceChecker.binomialCoefficient(n, k);
    List<Integer> A = new ArrayList<>(n);
    for (int i = 0; i < n; ++i) {
      A.add(i);
    }
    List<List<Integer>> combinations = new ArrayList<>();
    for (int i = 0; i < epi_solutions.test_framework.RandomSequenceChecker.binomialCoefficient(n, k); ++i) {
      combinations.add(epi_solutions.test_framework.RandomSequenceChecker.computeCombinationIdx(A, n, k, i));
    }
    ...
    return epi_solutions.test_framework.RandomSequenceChecker.checkSequenceIsUniformlyRandom(
